    ...
    <div>
        <el-container>
            <el-dialog :title="title" :visible.sync="isShow" width="500px" @close="cleanForm">
                <el-form :model="ruleForm">
                    ...
                    <el-form-item label="功能说明">
                        <el-input v-model="ruleForm.alias" style="width: 300px"></el-input>
                    </el-form-item>
                    <el-form-item label="使用实例">
                        <el-input v-model="ruleForm.use_case" style="width: 300px"></el-input>
                    </el-form-item>
                    <el-form-item label="参数说明">
                        <el-input v-model="ruleForm.parameters" style="width: 300px"></el-input>
                    </el-form-item>
                    <el-form-item label="输出内容">
                        <el-input v-model="ruleForm.output" style="width: 300px"></el-input>
                    </el-form-item>
                </el-form>
            ...
            <el-header class="user-header" height="300">
                ...
                标签说明:
                <el-input style="width: 300px" v-model="keyWords.alias"></el-input>
...
<script>
    //引入api方法
    import * as tpl from '../../api/template'
    export default {
        name: "tags",
        data() {
            return {
        ...
        methods:{
            ...
            submitForm(){
                if(this.id == 0){
                    tpl.addTags(this.ruleForm).then(res=>{
                        var error = res.code
                        var msg = res.msg
                    ...
                    tpl.updateTags(this.ruleForm).then(res => {
                            var error = res.code
                            var msg = res.msg
                            this.ruleLoading = false
